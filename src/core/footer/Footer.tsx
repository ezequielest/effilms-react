            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="footer__about">
                <div className="footer__logo">
                  <a className="bebas" href="http://effilms.com.ar">
                    EF FILMS
                  </a>
                </div>
                ...
                <ul>
                  ...
                  <li>
                    <a className="text-primary" href="https://wa.me/5492236688588" target="_blank">
                      +54 9 2236 68 8588
                    </a>
                  </li>
                  <li>
                    <QRCodeSVG
                      className="code-qr"
                      value="https://effilms.com.ar/contacto"
                      size={168}
                    />
                  </li>
                </ul>
                <div className="footer__social">
                  <a
                    href="https://api.whatsapp.com/send?phone=542236688588&text=Hola, me gustaría hacer contacto con ustedes."
                    target="_blank"
                  >
            ...
            <div className="row">
              <div className="col-lg-8 col-md-7">
                <div className="copyright__text">
                  <p>
                    Copyright © <script>document.write(new Date().getFullYear());</script> | Todos
