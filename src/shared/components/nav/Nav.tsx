...
export const Nav: React.FC = () => {
  ...
  return (
  <>
    <div className={`offcanvas-menu-overlay ${menuOpen ? 'active' : ''}`} onClick={handleOverlayClick}></div>
    <div className={`header offcanvas-menu-wrapper ${menuOpen ? 'active' : ''}`}>
        ...
        <div id="mobile-menu-wrap">
            <nav className="header-mobile position-fix">
              <ul>
                <li className="active"><Link to="/" onClick={handleOverlayClick}>Home</Link></li>
                <li><a href="/#equipo" onClick={handleOverlayClick}>Equipo</a></li>
                <li><Link to="/servicios" onClick={handleOverlayClick}>Servicios</Link></li>
                <li><a href="/#testimonials" onClick={handleOverlayClick}>Testimonios</a></li>
                <li style={{ position: 'relative' }}>
                  <a href="#" onClick={handleOverlayClick}>Blog</a>
                  {/*<span className="proximamente">próximamente</span>*/}
                </li>
                <li><a href="/#faqs" onClick={handleOverlayClick}>FAQS</a></li>
                <li><a href="/contacto" onClick={handleOverlayClick}>Contacto</a></li>
              </ul>
            </nav>
        </div>
        <div className="offcanvas__widget">
            ...
            <div className="landing__redes--mobile">
                <a href="https://api.whatsapp.com/send?phone=542236688588&text=Hola, me gustaría pedirles un presupuesto para mi alojamiento." target="_blank"><FontAwesomeIcon icon={faWhatsapp} /></a>
    ...
    <header className={`header animate__animated ${showNav ? 'fixed animate__fadeIn' : ''}`}> 
      <div className="container-fluid">
        ...
        <div className="canvas__open" onClick={handleMenu}><FontAwesomeIcon icon={faBars} /></div>
      </div>
    </header>
    </>
  );
