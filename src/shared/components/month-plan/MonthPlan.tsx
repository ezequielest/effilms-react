      ...
      <section id="plans" className="monthly spad table-price bg-gray-4">
        {/*<div className="monthly__header">
          <h2 className="title">
            ...
            {!thereIsAvailablePlaces ? (
              <span className="tag sold-out">AGOTADOS</span>
            ) : (
        ...
        <div className="cant_prods buttons-container">
          ...
          <div className="cant-prod">
            ...
            <div className="number-production">{cantMonthSelected}</div>
            <button
              className="btn btn-secondary"
              onClick={() => {
                incressProd();
            ...
            >
              ...
              <div className="leyend">
                {cantMonthSelected === prodsConfig.minProds && (
                  <span className="min-text"> MÍNIMO MENSUAL</span>
                )}
                {cantMonthSelected === prodsConfig.maxProds && (
                  <span className="max-text"> MÁXIMO MENSUAL</span>
                )}
              </div>
            </button>
          </div>
        ...
        <div className="monthly-card">
          {plansState.map((plan: Iplans, index) => (
            <CardPlan
              ...
              key={index}
              plan={plan}
              cantMonthSelected={cantMonthSelected}
        ...
        {/*div className="leyend-container">
          ...
          <ul className="leyend">
            <li>
              <strong>CONTRATO MÍNIMO DE 3 MESES</strong>
            </li>
            <li>ABONO FIJO MENSUAL</li>
            <li>ABONOS DEL 1 AL 10 DE CADA MES</li>
            <li>
              LAS PRODUCCIONES NO FILMADAS PUEDEN SER REALIZADAS EL MES POSTERIOR,<br></br> LUEGO DE
