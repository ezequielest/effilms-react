        ...
        <div className="container">
          <div className="row">
            ...
            <p className="text-center description mb-4">
              Los valores de los planes Mensual y 6M se calculan tomando como referencia el precio
              de una producción individual correspondiente al primer tramo de superficie (hasta 200
              m²), configurada con todos los servicios incluidos del nivel seleccionado. A partir de
              ese valor base se aplica el descuento correspondiente:
            </p>
