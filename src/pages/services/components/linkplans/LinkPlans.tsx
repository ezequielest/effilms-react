  ...
  const serviciosData = [
    {
      ...
      class: "",
      descripcion:
        "Elegi especificamente lo que necesitas de manera individual y a medida. Cotiza al instante!",
      listPro: [],
      listDownSide: [],
    },
    {
      ...
      class: "",
      descripcion:
        "Realiza varias producciones en el mismo mes y obtene un descuento adicional al valor individual.",
    ...
    },
    {
      ...
      descripcion:
        "Contamos con nuestro PLAN 6M, un plan a 6 meses bajo contrato con un valor preferencial para los que apuestan a futuro.",
      ...
      <div className="container">
        ...
        <div className="row mb-5 text-center">
          <div className="col">
            ...
            <h2 className="general-title display-4 fw-bold">
              ¿DE QUÉ MANERA TE GUSTARÍA ADQUIRIR ESTE SERVICIO?
            </h2>
          </div>
        </div>
            ...
            <div key={index} className="col-12 col-md-6 col-lg-4">
              <div className="card h-100 link-card text-center p-4 border-0 shadow-sm">
                <div className="card-body d-flex flex-column">
                  <h3 className="card-title h4 mb-3 fw-semibold">{servicio.titulo}</h3>
