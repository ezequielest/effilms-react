            ...
            <div className="col-lg-4 col-md-6">
              <div className="team__item set-bg anonimus">
                <div className="team__text">
                  ...
                  <div className="team__social">
                    <a
                      href="https://docs.google.com/forms/d/e/1FAIpQLSd05Iba1UM9gKgqSIzdq_DlBEGuiCvPXuj6ZY_0OXzs1ISqzg/viewform?usp=publish-editor"
                      target="_blank"
                    >
                      <FontAwesomeIcon icon={faArrowRight} /> FORMULARIO
                    </a>
                  </div>
                </div>
              </div>
