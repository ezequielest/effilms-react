...
import type { ClientMessage } from '../../../../core/models/ITestimonials.js';
    ...
    function handleBackWhatsapp() {
      ...
      return (
        ...
        <div className="vertical">EF<span className="dot-background">.</span>FILMS</div>
        <div className="container">
            ...
            <div className="container-whatsapp">
                        <div className="container-list-whatsapp">
                            ...
                            <div className="customer bianchi" onClick={() => {whatsappCustomer('bianchi', false)}}>
                                <div className="container-img">
                            ...
                            <div className="customer moire" onClick={() => {whatsappCustomer('moire', false)}}>
                            ...
                            <div className="customer malov" onClick={() => {whatsappCustomer('malov', false)}}>
                                <div className="container-img">
                            ...
                            <div className="customer soldeabril" onClick={() => {whatsappCustomer('soldeabril', false)}}>
                                <div className="container-img">
                            ...
                            <div key={index} className={`customer ${client.name}`} onClick={() => {whatsappCustomer(client.name, false)}}>
                                <div className="container-img">
                        ...
                        <div className="whatsapp bianchi" id="whatsapp-1">
                            <div className="whatsapp-chat">
                                <div className="whatsapp-chat-header">
                                    <div className="whatsapp-chat-header__back">
                                        <span onClick={() => {backWhatsapp() }}><i className="material-icons">&#xe5c4;</i></span>
                                        <img className="whatsapp-chat-header__back-photo" src="./img/testimonial/bianchi.jpg" alt="" />
                                    </div>
                                ...
                                <div className="whatsapp-chat-messages">
                                    <div className="chats">
                                        ...
                                        <div className="whatsapp-chat-message whatsapp-chat-messages__receiver">
                                            Y no son los mejores por sus trabajos que son excelentes. Sino por su humildad y su predisposición a aprender y crecer. Gracias a los dos
                        ...
                        <div className="whatsapp moire hide" id="whatsapp-3">
                            <div className="whatsapp-chat">
                                <div className="whatsapp-chat-header">
                                    <div className="whatsapp-chat-header__back">
                                        <span onClick={() => {backWhatsapp() }}><i className="material-icons">&#xe5c4;</i></span>
                                        <img className="whatsapp-chat-header__back-photo moire" src="./img/testimonial/moire.jpg" alt="" />
                                    </div>
                                ...
                                <div className="whatsapp-chat-messages">
                                    <div className="chats">
                                        ...
                                        <div className="whatsapp-chat-message whatsapp-chat-messages__receiver">
                                            Queremos agradecerles por el increíble trabajo que hicieron, valoramos mucho el profesionalismo con el que trabajaron desde el comienzo, siempre proponiendo nuevas ideas y trabajando para generar el material que ha superado nuestras expectativas. Nuevamente muchas gracias y seguiremos trabajando juntos!
                                            <span className="whatsapp-chat-messages__datetime">
                        ...
                        <div className="whatsapp malov hide" id="whatsapp-4">
                            <div className="whatsapp-chat">
                                <div className="whatsapp-chat-header">
                                    <div className="whatsapp-chat-header__back">
                                        <span onClick={() => {backWhatsapp() }}><i className="material-icons">&#xe5c4;</i></span>
                                        <img className="whatsapp-chat-header__back-photo" src="./img/testimonial/malov.png" alt="" />
                                    </div>
                        ...
                        <div className="whatsapp soldeabril hide" id="whatsapp-3">
                            <div className="whatsapp-chat">
                                <div className="whatsapp-chat-header">
                                    <div className="whatsapp-chat-header__back">
                                        <span onClick={() => {backWhatsapp() }}><i className="material-icons">&#xe5c4;</i></span>
                                        <img className="whatsapp-chat-header__back-photo" src="./img/testimonial/soldeabril.jpg" alt="" />
                                    </div>
                        ...
                        <div className="whatsapp beco hide" id="whatsapp-3">
                            <div className="whatsapp-chat">
                                <div className="whatsapp-chat-header">
                                    <div className="whatsapp-chat-header__back">
                                        <span onClick={() => {backWhatsapp() }}><i className="material-icons">&#xe5c4;</i></span>
                                        <img className="whatsapp-chat-header__back-photo" src="./img/testimonial/beco.jpg" alt="" />
                                    </div>
