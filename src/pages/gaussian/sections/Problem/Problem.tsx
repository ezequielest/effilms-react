      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-lg-8">
            <span className="problem__eyebrow">El desafío</span>
            ...
            <p className="problem__subtitle">
              La mayoría de los desarrollos se presentan con herramientas pensadas para mostrar, no
              para experimentar.
            </p>
          </div>
        </div>
          ...
          {problems.map((item) => (
            <div className="col-lg-4" key={item.number}>
              <article className="problem__card">
                <span className="problem__number">{item.number}</span>
