      ...
      <div className="container">
        <div className="row align-items-center gy-5">
          <div className="col-lg-5">
            <span className="experience__eyebrow">La solución</span>

            <h2 className="experience__title mb-4">
              Transformamos proyectos en experiencias digitales.
            </h2>

            <p className="experience__description">
              Combinamos visualización arquitectónica, tecnología interactiva y producción
              audiovisual para crear herramientas que ayudan a vender antes de construir.
            </p>
          </div>
          ...
          <div className="col-lg-7">
            <div className="experience__grid">
              {features.map((feature) => (
                <article className="experience__card" key={feature.title}>
