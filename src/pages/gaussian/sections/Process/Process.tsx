        ...
        <div className="row">
          <div className="col-lg-5">
            <div className="process__intro">
              <span className="process__eyebrow">Nuestro proceso</span>
              ...
              <p className="process__description">
                Cada proyecto sigue un flujo de trabajo diseñado para reducir tiempos, mejorar la
                comunicación y convertir ideas en herramientas reales de venta.
              </p>
            </div>
          </div>
