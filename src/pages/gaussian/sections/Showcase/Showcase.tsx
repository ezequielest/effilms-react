        ...
        <div className="row justify-content-center">
          <div className="col-xl-8">
            <div className="showcase__header">
              <span className="showcase__eyebrow">Experiencia interactiva</span>

              <h2 className="showcase__title">Descubrí un proyecto antes de que exista.</h2>

              <p className="showcase__description">
                Explorá cada ambiente, recorré los espacios, entendé la relación con el entorno y
                visualizá el proyecto como si ya estuviera construido.
              </p>
            </div>
          </div>
        </div>
